...
VelDirPluvInicio(void)
{
    ...
    ROM_ADCSequenceStepConfigure(ADC1_BASE, 0, 3, ADC_CTL_CH7);                                 // ADC_CTL_CH2 es el pin PD0    //  VBAT+
    ROM_ADCSequenceStepConfigure(ADC1_BASE, 0, 4, ADC_CTL_CH8 | ADC_CTL_IE | ADC_CTL_END);      // ADC_CTL_CH2 es el pin PE5    //  VBAT-
